 ...
 *         name
 */
public class FiltersDataHandler implements RequestHandler<Map<String, List<String>>, FilterDataDTO> {
	 ...
	 */
	@Override
	public FilterDataDTO handleRequest(Map<String, List<String>> request, Context context) {
	 ...
	 *         name
	 */
	public FilterDataDTO getProductCodes(Map<String, List<String>> request, Context context) {
		context.getLogger().log("input: " + request);
	 ...
	 */
	public FilterDataDTO getShipCodes(Map<String, List<String>> request, Context context) {
		FilterDataService dataService = null;
		FilterDataDTO response = null;
		try {
			dataService = new FilterDataService();
	 ...
	 */
	public FilterDataDTO getSailMonths(Map<String, List<String>> request, Context context) {
		FilterDataService dataService = null;
		FilterDataDTO response = null;
		try {
			dataService = new FilterDataService();
	...
	public FilterDataDTO getCatClasses(Map<String, List<String>> request, Context context) {
		FilterDataService dataService = null;
		FilterDataDTO response = null;
		try {
			dataService = new FilterDataService();
	 ...
	 */
	public FilterDataDTO getCategories(Map<String, List<String>> request, Context context) {
		FilterDataService dataService = null;
		FilterDataDTO response = null;
		try {
			dataService = new FilterDataService();
	 ...
	 */
	public FilterDataDTO getOccupancy(Map<String, List<String>> request, Context context) {
		FilterDataService dataService = null;
		FilterDataDTO response = null;
		try {
			dataService = new FilterDataService();
