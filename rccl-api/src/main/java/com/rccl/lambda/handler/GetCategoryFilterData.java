 ...
 *
 */
public class GetCategoryFilterData implements RequestHandler<Map<String, List<String>>, FilterDataDTO> {
	...
	public FilterDataDTO handleRequest(Map<String, List<String>> requestMap, Context context) {
		...
		FilterDataDTO response = //new FilterDataDTO();
				dataService.getFilterData(FiltersData.getRequestData(), RCCLConstants.CATEGORY_F);
	...
	public static void main(String[] args) {
		System.out.println(new GetCategoryFilterData().handleRequest(null, null));
	}
