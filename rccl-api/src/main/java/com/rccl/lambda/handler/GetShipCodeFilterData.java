 ...
 *
 */
public class GetShipCodeFilterData implements RequestHandler<Map<String, List<String>>, FilterDataDTO> {
	...
	public FilterDataDTO handleRequest(Map<String, List<String>> requestMap, Context context) {
		...
		FilterDataDTO response = //new FilterDataDTO();
				dataService.getFilterData(FiltersData.getRequestData(), RCCLConstants.SHIP_CODE_F);
	...
	public static void main(String[] args) {
		System.out.println(new GetShipCodeFilterData().handleRequest(null, null));
	}
